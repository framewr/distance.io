...
// Distance singleton and namespace
...
/*</DEBUG>*/
                ...
                // Tracker URL
                configTrackerUrl = trackerUrl || 'http://distance.io/api',
            ...
            /*
             * Send image request to Distance server using GET.
            ...
            /*
             * POST request to Distance server using XMLHttpRequest.
             */
            ...
            /* Send geo request */
            function sendGeoRequest(request, delay) {
                ...
                function show_map(position) {
                    // geolocation
                    request += '&lat=' + position.coords.latitude;
                    request += '&lon=' + position.coords.longitude;
            ...
            function getCookieName(baseName) {
                // NOTE: If the cookie name is changed, we must also update the DistanceTracker.php which
            ...
            function getRequest(request, customData, pluginMethod, currentEcommerceOrderTs) {
                ...
                // do not send charset if it is utf8 since it's assumed by default in Distance
            ...
            function logEcommerce(orderId, grandTotal, subTotal, tax, shipping, discount) {
                ...
                sendGeoRequest(request, configTrackerPause);
            }
                    ...
                    setTimeout(function heartBeat() {
                        ...
                        if ((lastActivityTime + configHeartBeatTimer) > now.getTime()) {
                            ...
                            if (configMinimumVisitTime < now.getTime()) {
                                ...
                                sendGeoRequest(requestPing, configTrackerPause);
                            }
...
/*</DEBUG>*/
        ...
        // Expose Distance as an AMD module
        if (typeof define === 'function' && define.amd) {
            define('piwik', [], function () { return Distance; });
        }
...
if (typeof piwik_log !== 'function') {
    piwik_log = function (documentTitle, siteId, piwikUrl, customData) {
        ...
        var option,
            piwikTracker = Distance.getTracker(piwikUrl, siteId);
